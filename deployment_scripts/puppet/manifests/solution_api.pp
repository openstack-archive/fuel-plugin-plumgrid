...
exec { 'Send Environment data to Solution API server':
  command => "/usr/bin/curl -H \"Content-Type: application/json\" -X PUT -d \'{\"solution_name\":\"Mirantis\",\"solution_version\":\"8.0\",\"pg_ons_version\":\"6.0.0.b14\",\"hypervisor\":\"Ubuntu\",\"hypervisor_version\":\"14.04\", \"kernel_version\":\"3.19.0-47-generic\",\"pg_cloudapex_version\":\"1.0\"}\' http://$plumgrid_pkg_repo:8099/v1/zones/$plumgrid_zone/zoneInfo" }
